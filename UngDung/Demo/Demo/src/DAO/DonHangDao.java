...
PreparedStatement pst = null; 
    public int addDonHang(DonHang d) {
        int kq = -1;
        try {
            String insert = "insert into DonHang(TenDN,NgayDat,HinhThucThanhToan,ChiTietDiaChi,HoTen,SoDienThoai,isDelete) values(?,?,?,?,?,?,0);";
    ...
    public int getMaDonHang(String TenDN, String NgayDat) {
        ...
        try {
            ...
            String kt = "select MaDonHang From DonHang where TenDN='" + TenDN + "' and NgayDat='" + NgayDat + "'";
