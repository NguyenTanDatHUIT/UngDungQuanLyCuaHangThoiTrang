...
public class ChiTietSanPhamDao {
    ...
    public ChiTietSanPham get1CTSP(String MaSP) {
        ...
        try {
            ...
            String sql = "select MaCT,ThuongHieu,ct.MaSanPham,ct.TenSanPham,ct.Gia,ct.Anh1,Anh2,Anh3,MoTa1,MoTa2,MoTa3,MoTa4,ct.isDelete,ctsp.SanPhamTon  "
                    + "from ChitietSP ct,SanPham ctsp"
                    + " where ct.MaSanPham=ctsp.MaSanPham and ct.MaSanPham='" + MaSP + "';";
            ...
            while (rs.next()) {
                ...
                s.setIsDeleted(rs.getString(13));
                s.setSanPhamTon(rs.getString(14));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
