...
('CTSP17',N'VASCARA','SP015',null,null,'WAL0271.jpg','WAL02712.jpg','WAL02713.jpg',N'23 x 6.6 x 13.2 cm',N'Da thật ',N'Khóa nam châm',N'2 ngăn lớn, 3 ngăn nhỏ',0),
('CTSP18',N'VASCARA','SP015',null,null,'CLU0112.jpg','CLU01122.jpg','CLU01123.jpg',N'23 x 6.6 x 13.2 cm',N'Da thật ',N'Khóa nam châm',N'2 ngăn lớn, 3 ngăn nhỏ',0),
...
VALUES
  ('24/05/2024', 12345678.90, N'Tiền mặt', N'Phiếu nhập hàng ngày 24/05/2024',0),
  ('25/05/2024', 98765432.10, N'Chuyển khoản', N'Phiếu nhập hàng ngày 25/05/2024',0);
go
select * from PhieuNhap
SET IDENTITY_INSERT PhieuNhap ON;
INSERT INTO ChiTietPhieuNhap (MaPhieuNhap,MaSanPham,DonViTinh,SoLuong,DonGiaNhap,ThanhTien)
VALUES
  (1, 'SP001', N'Cái', 10, 1000000, 1000000),
  (1, 'SP002', N'Cái', 8, 950000, 760000),
  (1, 'SP003', N'Cái', 12, 950000, 1140000),
  (1, 'SP004', N'Cái', 15, 584000, 876000),
  (1, 'SP005', N'Cái', 14, 614000, 869600),
  (2, 'SP010', N'Cái', 20, 1200000, 2400000),
  (2, 'SP013', N'Cái', 15, 990000, 1485000),
  (2, 'SP014', N'Cái', 12, 1300000, 1560000),
  (2, 'SP016', N'Cái', 18, 1200000, 2160000),
  (2, 'SP019', N'Cái', 15, 600000, 900000);
go
